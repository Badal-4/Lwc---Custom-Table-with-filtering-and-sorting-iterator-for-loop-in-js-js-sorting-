...
import fetchAccounts from '@salesforce/apex/lwcController.fetchAccounts';
export default class sample extends LightningElement 
{
  ...
  sortRecs(event)
  {
    ...
    console.log('Columns Name is-->'+colName);
    ...
    {
      a = a[colName] ? a[colName].toLowerCase() : '';//handle null value 
